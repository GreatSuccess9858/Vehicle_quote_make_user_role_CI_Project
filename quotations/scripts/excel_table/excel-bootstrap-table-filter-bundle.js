(function($$1) {
	...
	var FilterCollection = function() {
		...
		FilterCollection.prototype.updateRowVisibility = function(filterMenus, rows, ths) {
			...
			console.log("FINISH UPDATE " + jQuery("#table tr:visible").length);

			var _table = jQuery(ths).closest('table').attr("id")
			_helper_trigger_element("custom__table", _table, ths);
			/*jQuery("body").on('custom__reload_table', '.selector', function(event) {
