        ...
        <div class="col-md-5 center-block-e">
            ...
            <div class="login-form">
                <div class="login-form-inner">
                    ...
                    <?php endif; ?>
                    <?php echo form_open(site_url("registros/register_tutor"), array("id" => "register_form")) ?>
                    <div class="form-group login-form-area has-feedback">
                        <input type="text" class="form-control" name="nombres"
                               placeholder="<?php echo lang("nombres") ?>" id="nombres"
                    ...
                    <div class="form-group login-form-area has-feedback">
                        <input type="text" class="form-control" name="apellidos"
                               placeholder="<?php echo lang("apellidos") ?>" id="apellidos"
                    ...
                    <div class="form-group login-form-area has-feedback">
                        <input type="text" class="form-control" name="telefono"
                               placeholder="<?php echo lang("telefono") ?>" id="telefono"
                    ...
                    <div class="form-group login-form-area has-feedback">
                        <?php
                        $objs = _all_rows('ce_paises', 'status=1', 'id,nombres');
                        ?>
                        <select name="paises_id" style="padding-left: 30px;" class="form-control" id="paises_id">
                            <option value="">  <?php echo _l('select_country'); ?></option>
                            <?php
                            if ($objs):
                                foreach ($objs as $k => $obj): ?>
                                    <option value="<?php echo $obj->id ?>"><?php echo $obj->nombres; ?></option>
                                <?php endforeach;
                            endif; ?>
                        </select>
                        <i class="glyphicon glyphicon-envelope form-control-feedback login-icon-color"
                           id="login-icon-flag"></i>
                    </div>
                    <div class="form-group login-form-area has-feedback">
                        <input type="text" class="form-control" name="email" placeholder="<?php _l("email") ?>"
                    ...
                    <div class="form-group login-form-area has-feedback">
                        <input type="text" class="form-control" name="username" id="username"
                               placeholder="<?php _l("nombre_usuario") ?>"
                    ...
                    <div class="form-group login-form-area has-feedback">
                        <label for="factura_flag">
                            <input type="checkbox" id="factura_flag" name="factura_flag" class=""
                                   value="1" <?php if (isset($factura_flag)) echo ($factura_flag) ? 'checked' : ''; ?> >
                            ¿Requiere factura?
                        </label>
                    ...
                    <div class="bloque-facturacion">
                        ...
                        <div class="form-group login-form-area has-feedback">
                            <input type="text" class="form-control" name="facturacion[nombres]"
                                   placeholder="<?php echo _l("facturacion_nombre") ?>" id="facturacion_nombres"
                                   value="<?php if (isset($facturacion_nombres)) echo $facturacion_nombres; ?>">
                            <i class="glyphicon glyphicon-envelope form-control-feedback login-icon-color"
                               id="login-icon-email"></i>
                        </div>
                    </div>
                    <div class="form-group login-form-area has-feedback">
                        <select name="tipo_tutor" required style="padding-left: 30px;" class="form-control"
                                id="tipo_tutor">
                            <option value="">  <?php echo _l('select_option_tipo_tutor'); ?></option>

                            <option value="1"> Soy el padre/madre de los estudiantes a inscribir</option>
                            <option value="2"> Estoy a cargo de un centro educativo digital</option>
                        </select>


                    </div>
                    <div class="bloque-colegio">

                        <div class="form-group login-form-area has-feedback">
                            <input type="text" class="form-control" name="colegio[nombres]"
                                   placeholder="<?php echo _l("colegio_nombre") ?>" id="colegio_nombres"
                                   value="<?php if (isset($colegio_nombres)) echo $colegio_nombres; ?>">
                            <i class="glyphicon glyphicon-envelope form-control-feedback login-icon-color"
                               id="login-icon-email"></i>
                        </div>
                        <div class="form-group login-form-area has-feedback">
                            <input type="text" class="form-control" name="colegio[direccion]"
                                   placeholder="<?php echo _l("colegio_direccion") ?>" id="colegio_direccion"
                                   value="<?php if (isset($colegio_direccion)) echo $colegio_direccion; ?>">
                            <i class="glyphicon glyphicon-envelope form-control-feedback login-icon-color"
                               id="login-icon-email"></i>
                        </div>
                        <div class="form-group login-form-area has-feedback">
                            <input type="text" class="form-control" name="colegio[telefono]"
                                   placeholder="<?php echo _l("colegio_telefono") ?>" id="colegio_telefono"
                                   value="<?php if (isset($colegio_telefono)) echo $colegio_telefono; ?>">
                            <i class="glyphicon glyphicon-envelope form-control-feedback login-icon-color"
                               id="login-icon-email"></i>
                        </div>
                        <div class="form-group login-form-area has-feedback">
                            <input type="text" class="form-control" name="colegio[email_contacto]"
                                   placeholder="<?php echo _l("colegio_email_contacto") ?>" id="colegio_email_contacto"
                                   value="<?php if (isset($colegio_email_contacto)) echo $colegio_email_contacto; ?>">
                            <i class="glyphicon glyphicon-envelope form-control-feedback login-icon-color"
                               id="login-icon-email"></i>
                        </div>

                        <div class="form-group login-form-area has-feedback">
                            <p>Ubicación del centro educativo</p>
                            #mapa#
                        </div>

                        <div class="form-group login-form-area has-feedback">
                            <label for="colegio_datos_flag">
                                <input type="checkbox" id="colegio_datos_flag" name="colegio[datos_publicos]" class=""
                                       value="1" <?php if (isset($colegio_datos_flag)) echo ($colegio_datos_flag) ? 'checked' : ''; ?> >
