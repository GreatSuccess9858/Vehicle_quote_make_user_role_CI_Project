    ...
    <div class='form-content form-div'>
        ...
        <div class="table-bordered">
            ...
            foreach ($fields as $field) {
                ...
                $counter++;
                ?>
                <div class='form-field-box <?php echo $even_odd ?> d-flex justify-content-between col-sm-12' id="<?php echo $field->field_name; ?>_field_box">
        ...
        <div class='buttons-box'>
            <div class='form-button-box'>
                <input type='button' value='<?php echo $this->l('form_back_to_list'); ?>'
                       class='btn btn-raised btn-info float-right' id="cancel-button"/>
            </div>
            <div class='clear'></div>
        </div>
        </form>
